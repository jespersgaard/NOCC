...
$html_wrong = 'Utilizador ou palavra-chave incorrectos';
...
$html_folders_updated = 'Pastas actualizadas';
...
$html_filter_action = 'Acção do Filtro';
...
$html_attach_none = 'Tem de seleccionar um ficheiro para anexar!';
...
$html_msg = 'Mensagem';
$html_msgs = 'Mensagens';
$html_configuration = 'Este servidor não está configurado correctamente!';
...
$html_select_all = 'Inverter selecção';
...
$html_no_sendaction = 'Nenhuma acção indicada. Tente activar o JavaScript.';
...
$html_del_msg = 'Apagar as mensagens seleccionadas?';
