...
$html_msgperpage = 'Nohresschte op jeede Sigk';
$html_preferences = 'Aanjabe';
$html_full_name = 'Dä kumplätte Nam';
$html_email_address = 'De Adräß för de <i lang="en">e-mail</i>';
...
$html_reply_leadin = 'Der Aanfang för en Antwoot';
...
$html_sent_folder = 'Donn de eruß jeschek Nohreschte en e beschtemmp Verzeischnes koppeere';
$html_trash_folder = 'Donn de fottjeschmeße Nohreschte en e beschtemmp Verzeischnes koppeere';
...
$html_folders_unsub_failed = 'Mer kunnte dat Abbonnemong fö dat Verzeischneß nit ophüüre!';
...
$html_att = 'Aanhang';
$html_atts = 'Aanhäng';
$html_att_unknown = '[weße mer nit]';
$html_attach = 'Draanhänge';
$html_attach_forget = 'Do moß Ding Datei aanjehange han, ih dat De di Nohresh verschecke kanns.';
$html_attach_delete = 'Fottschmiiße, wat makeet es';
$html_attach_none = 'Do moß ald en Datei för draanzehänge ußsöhke!';
$html_sort_by = 'Zoteere noh';
$html_sort = 'Zoteere';
$html_from = 'Vun';
$html_date = 'Dattum';
$html_sent = 'Verschecker';
...
$html_loading_image = 'Ben a Beld aam Laade';
