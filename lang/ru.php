...
$html_theme = 'Дизайн';
$html_lang = 'Язык';
$html_welcome = 'Добро пожаловать в %1$';
$html_login = 'Имя';
$html_passwd = 'Пароль';
$html_submit = 'Войти';
$html_help = 'Помощь';
...
$html_sent_folder = 'Скопировать почту в выделенную папку';
$html_trash_folder = 'Переместить письма в выделенную папку';
...
$html_encoding = 'Кодировка';
$html_add = 'Добавить';
$html_contacts = '%1$s Контактов';
...
$html_contact_list = 'Список контактов пользователя %1$s';
$html_contact_del = 'из контактного листа';
$html_contact_count = '%1$d контактов';
$html_contact_err1 = 'Максимальное число контактов — «%1$d»';
