...
$html_use_graphical_smilies = 'Използване на графични усмивки';
...
$html_atts_label_label = 'Прикачени файлове:';
$html_attach = 'Прикачи';
...
$html_prefs_file_error = 'Беше невъзможно да бъде отворен за писане файлът с предпочитания';
...
$html_err_file_contacts = 'Беше невъзможно да бъде отворен за писане файлът с контакти.';
$html_session_file_error = 'Беше невъзможно да бъде отворен сесийният файл за писане.';
