...
$html_use_graphical_smilies = 'Folosiţi zâmbăreţele grafice';
$html_colored_quotes = 'Citate colorate';
$html_send_html_mail = 'Trimiteţi e-mail în format HTML';
...
$html_folder_rename = 'Redenumeşte';
$html_folder_create = 'Creaţi un nou folder numit';
$html_folder_remove = 'Dezabonare de la';
$html_folder_delete = 'Ştergeţi';
$html_folder_to = 'către';
$html_filter_remove = 'Ştergeţi';
$html_filter_body = 'Corp mesaj';
$html_filter_subject = 'Subiect mesaj';
$html_filter_to = 'Câmpul „către”';
$html_filter_cc = 'Câmpul „cc”';
$html_filter_from = 'Câmpul „de la”';
$html_filter_change_tip = 'Pentru a schimba un filtru, pur şi simplu suprascrieţi-l.';
$html_reapply_filters = 'Reaplicaţi toate filtrele';
$html_filter_contains = 'conţine';
$html_filter_name = 'Nume filtru';
$html_filter_action = 'Acţiune filtru';
$html_select_one = '--Alegeţi una--';
$html_and = 'şi';
