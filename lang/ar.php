...
$html_msgperpage = 'رسائل لكل صفحة';
$html_preferences = 'تفضيلات';
$html_full_name = 'الاسم الكامل';
$html_email_address = 'عنوان البريد الإلكتروني';
...
$lang_err_send_delay = 'يتعين عليك الانتظار بين الرسالتين';
$lang_seconds = 'ثواني';
$html_search = 'بحث';
