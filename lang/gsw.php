...
$html_msgperpage = 'Nochrichte pro Syte';
$html_preferences = 'Yystellige';
$html_full_name = 'Vollständige Name';
$html_email_address = 'E-Mail-Adräss';
$html_ccself = 'Kopii vu dr Nochrichte an di eige Adräss schicke';
...
$html_reply_leadin = 'Antwort-Yyleitig';
...
$html_sent_folder = 'Kopier di verschickt E-Mail in s Verzeichnis, wu aagee isch';
$html_trash_folder = 'Gleschti Mail in dr Ordner verschiebe, wu aagee isch';
...
$html_wrap = 'Di verschickte Nochrichte no x Zeiche umbräche:';
$html_wrap_none = 'Kei';
...
$lang_err_send_delay = 'Du muesch zwische zwoo Mails warte (%1$d Sekunde)';
$html_search = 'Sueche';
