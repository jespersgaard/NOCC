...
$html_msgperpage = '페이지당 메세지의 숫자';
$html_preferences = '선택사항';
$html_full_name = '성명';
$html_email_address = '이메일 주소';
$html_ccself = '본인참조';
...
$html_sent_folder = '지정된 폴더에 보낸 메일을 저장하기';
$html_trash_folder = '삭제한 메일을 지정된 폴더로 이동시키기';
