...
$html_email_address_label = 'نشانی پست الکترونیک';
...
$html_manage_filters_link = 'مدیریت فیلترهای پست الکترونیک';
$html_use_graphical_smilies = 'استفاده از شکلک های گرافیکی';
$html_sent_folder_label = 'کپی نامه الکترونیکی به پوشه اختصاصی:';
$html_trash_folder_label = 'انتقال نامه الکترونیکی به پوشه اختصاصی:';
$html_colored_quotes = 'نقل‌قول رنگی';
$html_display_struct = 'نمایش  ساختار متن';
$html_send_html_mail = 'ارسال پست الکترونیکی در قالب متنی';
...
$html_invalid_email_address = 'نشانی پست الکترونیکی غیرمعتبر';
