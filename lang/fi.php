...
$html_msgperpage = 'Viestejä sivulla';
...
$html_sent_folder = 'Kopioi lähetetyt sähköpostit omaan kansioonsa';
$html_trash_folder = 'Siirrä poistetut sähköpostit omaan kansioonsa';
...
$html_contact_err1 = 'Yhteystietojen suurin sallittu määrä on';
