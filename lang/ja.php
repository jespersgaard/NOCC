...
$html_email_address_label = '電子メールアドレス';
...
$html_sent_folder_label = '専用のフォルダーに送信メールをコピーしました';
$html_trash_folder_label = '削除されたメールを専用のフォルダへ移動する';
...
$html_read = '既読';
$html_unread = '未読';
$html_encoding_label = '文字エンコーディング';
$html_add = '追加';
