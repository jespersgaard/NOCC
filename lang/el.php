...
$html_msgperpage = 'Μηνύματα ανά σελίδα';
...
$html_reply_leadin = 'Εισαγωγική φράση Απάντησης';
...
$html_sent_folder = 'Αντιγραφή αποσταλμένων μηνυμάτων σε έναν αποκλειστικό φάκελο';
$html_trash_folder = 'Μετακίνηση διεγραμμένων μηνυμάτων σε έναν αποκλειστικό φάκελο';
...
$html_wrap = 'Αναδίπλωση γραμμών εξερχόμενων μηνυμάτων σε :';
...
$html_encoding = 'Κωδικοποίηση χαρακτήρων';
$html_add = 'Προσθήκη';
...
$lang_err_send_delay = 'Πρέπει να περιμένετε μεταξύ δύο μηνυμάτων (%1$d δευτερόλεπτα)';
