...
<div class="mainmenu">
  <ul>
    ...
    <li>
      <a href="javascript:void(0);" onclick="window.open('contacts_manager.php?<?php echo NOCC_Session::getUrlQuery(); ?>','','scrollbars=yes,resizable=yes,width=600,height=400')"><?php echo i18n_message($html_contacts, ''); ?></a>
    </li>
    <?php } ?>
