<!-- start of $Id: menu_mail.php,v 1.35 2006/02/26 09:32:53 goddess_skuld Exp $ -->
<?php
...
<div class="menuMail">
  <table>
    <tr>
      ...
      <td class="menu">
        <a href="delete.php?delete_mode=1&amp;mail=<?php echo $content['msgnum'] ?>&amp;only_one=1" onclick="if (confirm('<?php echo $html_del_msg ?>')) return true; else return false;"><?php echo htmlentities($html_delete) ?></a>
      </td>
...
<!-- end of $Id: menu_mail.php,v 1.35 2006/02/26 09:32:53 goddess_skuld Exp $ -->
