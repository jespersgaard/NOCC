<!-- start of $Id: menu_mail.php,v 1.37 2006/10/10 12:52:52 goddess_skuld Exp $ -->
<?php
...
<div class="menuMail">
  <table>
    <tr>
      ...
      <td class="menu">
        <a href="down_mail.php?mail=<?php echo $content['msgnum'] ?>"><?php echo htmlentities($html_down_mail, ENT_COMPAT, 'UTF-8') ?></a>
      </td>
      <td class="menu">
...
<!-- end of $Id: menu_mail.php,v 1.37 2006/10/10 12:52:52 goddess_skuld Exp $ -->
