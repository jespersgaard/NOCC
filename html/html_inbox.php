<!-- start of $Id: html_inbox.php,v 1.42 2002/06/30 21:43:46 rossigee Exp $ -->
<tr bgcolor="<?php echo $glob_theme->inbox_color ?>">
    ...
    <td class="inbox" align="left">
        <a href="<?php echo $_SERVER['PHP_SELF'] ?>?action=aff_mail&amp;mail=<?php echo $tmp['number'] ?>&amp;verbose=0&amp" title="<?php echo $tmp['subject']? htmlspecialchars($tmp['subject']) : $html_nosubject; ?>" <?php if($user_prefs->seperate_msg_win) echo "target=\"message\""; ?> ><?php echo $tmp['subject']? substr(htmlspecialchars($tmp['subject']), 0, 55) : $html_nosubject; ?></a>
    </td>
    <td class="inbox" align="left">
        <?php echo $tmp['date'] ?>
        <?php echo $tmp['time'] ?>
...
<!-- end of $Id: html_inbox.php,v 1.42 2002/06/30 21:43:46 rossigee Exp $ -->
