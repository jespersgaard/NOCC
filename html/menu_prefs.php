<!-- start of $Id: menu_prefs.php,v 1.9 2002/04/15 02:18:14 mrylander Exp $ -->
            ...
            <table border="0" cellpadding="2" cellspacing="1" bgcolor="<?php echo $glob_theme->inside_color ?>" width="100%">
                <tr>
                    <td class="menu" align="center" width="120" bgcolor="<?php echo $glob_theme->menu_color ?>">
                        <a href="<?php echo $PHP_SELF ?>?folder=<?php echo $folder ?>&amp;lang=<?php echo $lang ?>&amp;sort=<?php echo $sort ?>&amp;sortdir=<?php echo $sortdir ?>" class="menu"><?php echo $folder ?></a>
                    </td>
                    <td class="menu" align="center" width="120" bgcolor="<?php echo $glob_theme->menu_color ?>">
...
<!-- end of $Id: menu_prefs.php,v 1.9 2002/04/15 02:18:14 mrylander Exp $ -->
