...
<table width="100%" cellpadding="2" cellspacing="1" border="0" bgcolor="<? echo $html_inside_color ?>">
	...
	<tr bgcolor="<? echo $inbox_text_color ?>">
		...
		<td nowrap="nowrap" align="center" class="inbox" <? if ($sort == 2) echo "bgcolor='$html_sort_color'" ?>>
		...
		<td nowrap="nowrap" align="center" class="inbox" <? if ($sort == 3) echo "bgcolor=\"$html_sort_color\"" ?>>
		...
		<td nowrap="nowrap" align="center" class="inbox" <? if ($sort == 1) echo "bgcolor=\"$html_sort_color\"" ?>>
		...
		<td nowrap="nowrap" align="right" class="inbox" <? if ($sort == 6) echo "bgcolor=\"$html_sort_color\"" ?>>
