...
?></option>
				...
				<TR>
					...
					<TD><INPUT TYPE="text" NAME="to" SIZE="80" MAXLENGTH="200" VALUE="<?echo 
$mail_to?>"></td>
				</TR>
				<TR>
					<TD ALIGN="RIGHT" class="inbox"><? echo $html_cc ?> : </TD>
					<TD><INPUT TYPE="text" NAME="cc" SIZE="80" MAXLENGTH="200" VALUE="<?echo 
$mail_cc?>"></td>
				</TR>
				<TR>
					<TD ALIGN="RIGHT" class="inbox"><? echo $html_bcc ?> : </TD>
					<TD><INPUT TYPE="text" NAME="bcc" SIZE="80" MAXLENGTH="200" VALUE="<?echo 
$mail_bcc?>"></td>
				</TR>
				<TR>
					<TD ALIGN="RIGHT" class="inbox"><? echo $html_subject ?> : </TD>
					<TD><INPUT TYPE="text" NAME="subject" SIZE="80" MAXLENGTH="200" VALUE="<?echo 
$mail_subject?>"></TD>
				</TR>
				<TR>
...
WRAP="physical"><?echo $mail_body?></TEXTAREA></TD>
				...
				<TR>
					<TD align="center" colspan="2">
						<TABLE bgcolor="<? echo $html_inside_color ?>" bordercolor="#000000" WIDTH="100%" 
