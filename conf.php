...
$enable_logout = true; // the user can logout or not (if nocc is used within your website put 'false' here else leave 'true'
$default_sort = "1"; // By default the messages are sorted by date ()
$default_sortdir = "1"; // By default the most recent is in top ("1" --> sorting top to bottom, "0" --> bottom to top)
...
$html_menu_color = "#99ccff"; // Color of the navigation button (inbox, write, answer, etc.) - default is "sky blue"
$html_menu_color_on = "#FFC061"; // The same as above when the user is in that part - default is "orange"
$html_mail_properties = "#99ccff"; // Mail properties color (to, from, subject, attachments, etc.) - default is "sky blue"
$html_inside_color = "#f0f0f0"; // Color of the inside of the root table - default is "grey"
$html_tr_color = "#002266"; // Color of the Inbox line and the garbage line and of the outside page - default is "dark blue"
$html_sort_color = "#ffffcc"; // color for the highlight of the sorting in the mailbox - default is "yellow"
